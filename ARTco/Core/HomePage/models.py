...
class Visita(models.Model):
    ...
    slog_visita = models.SlugField(max_length=255, blank=True, null=True, unique=True)
...
def generador_slog(sender, instance, **kwargs):
        if not instance.slog_visita:
            a=str(uuid.uuid4())
            ...
            instance.slog_visita = a + '-' + b + '-' + c
    
pre_save.connect(generador_slog, sender=Visita)
